    ...
    public class InputEmulator : MonoBehaviour
    {
...
#endif
            if (FindAnyObjectByType<InputEmulator>() != null) return;
            var emulatorObject = new GameObject("InputEmulator");
            emulatorObject.AddComponent<InputEmulator>();
        ...
        private void EndTwoFinger()
        {
            ...
            else if (_twoFingerDragging)
            {
                ...
                InputEvents.TwoFingerSwipe(Vector2.zero, center);
        ...
        private void UpdateThreeFinger()
        {
            ...
            if (delta.sqrMagnitude > 0f)
            {
                ...
                InputEvents.Drag(direction, center);
            }
            _lastThreeFingerPos = current;
        }
        ...
        private void HandleSingleFinger()
        {
            ...
            if (_singleDown && UnityEngine.Input.GetMouseButton(0))
            {
                ...
                if (_singleDragging && delta.sqrMagnitude > 0.0001f)
                {
                    ...
                    InputEvents.Drag(delta, current);
                }
                _lastSinglePos = current;
            }
        ...
        private void ForceReleaseIfButtonsUp()
        {
            ...
            if (_singleDown && !UnityEngine.Input.GetMouseButton(0))
            {
                ...
                if (!_singleBlockedByUi && router != null && !_singleDragging && !_suppressTap && Time.time - _singleStartTime <= TapMaxTime)
                {
                    ...
                    InputEvents.Tap(_lastSinglePos);
                }
                _singleDown = false;
                _singleDragging = false;
                _singleBlockedByUi = false;
        ...
        )
        {
            ...
            InputEvents.Drag(panDelta, center);
        }
        ...
        private void ApplySmoothedScrollZoom()
        {
            ...
            InputEvents.PinchZoom(zoomStep);
        }
        ...
        private void TrySelect(Vector3 screenPosition, InputRouter router)
        {
            ...
            {
                Debug.Log($"[InputEmulator] Click hit {hit.collider.name} at {hit.point}");
            ...
            {
                Debug.Log("[InputEmulator] Click hit nothing.");
                router.Cancel();
            }
        }
        ...
        private void EnsureSettingsLoaded()
        {
            ...
            if (!_warnedMissingSettings)
            {
                ...
                Debug.LogWarning(
                    $"[InputEmulator] Missing settings asset. " +
        ...
        private InputRouter TryGetRouter()
        {
            ...
            if (router == null && !_warnedMissingRouter)
            {
                ...
                Debug.LogWarning("[InputEmulator] InputRouter.Instance is null. Input routing disabled.");
            }
            return router;
        }
