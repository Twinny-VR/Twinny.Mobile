...
{
    [CreateAssetMenu(fileName = "TwinnyMobileRuntimePreset", menuName = "Twinny/Mobile Runtime")]
    public class TwinnyMobileRuntime : TwinnyRuntime
    {
        private const string MobileDefaultSceneName = "MobileMockupScene";
        private static TwinnyMobileRuntime _instance;
        ...
        public static TwinnyMobileRuntime GetInstance(bool forceCreate = false)
        {
            if (_instance == null)
                _instance = Resources.Load<TwinnyMobileRuntime>("TwinnyMobileRuntimePreset");

            if (_instance == null && forceCreate)
            {
                _instance = TwinnyRuntime.CreateAsset<TwinnyMobileRuntime>();
                if (_instance != null)
                {
