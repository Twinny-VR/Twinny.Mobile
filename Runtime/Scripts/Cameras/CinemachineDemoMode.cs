...
namespace Twinny.Multiplatform.Cameras
{
    ...
    public class CinemachineDemoMode : MonoBehaviour, IPlatformInputCallbacks
    {
        [Header("Idle")]
        ...
        [SerializeField] private CinemachineOrbitalHandler _orbitalHandler;
        ...
        private void OnDisable()
        {
            ...
            if (_isDemoActive)
                CallbackHub.CallAction<IPlatformCallbacks>(callback => callback.OnExitDemoMode());
            _isDemoActive = false;
        ...
        private void StartDemo()
        {
            ...
            _isDemoActive = true;
            CallbackHub.CallAction<IPlatformCallbacks>(callback => callback.OnEnterDemoMode());
            if (_logState)
                Debug.Log("[CinemachineDemoMode] Demo started.");
        }
        ...
        private void StopDemo(bool resetIdleTimer)
        {
            ...
            RestoreCameraTargets();
            if (_logState)
                Debug.Log("[CinemachineDemoMode] Demo stopped.");
        }
        ...
        private void EnsureReferences()
        {
            ...
            if (_orbitalHandler == null)
                _orbitalHandler = GetComponent<CinemachineOrbitalHandler>();
        }
