...
namespace Twinny.Multiplatform.Cameras
{
    ...
    public class CinemachineFpsHandler : MonoBehaviour, IPlatformInputCallbacks, IPlatformCallbacks, IPlatformUICallbacks
    {
        [Header("Cinemachine")]
        ...
        private void ApplyGyroRotation(Vector3 tiltRotation)
        {
            ...
            if (!IsActiveCamera()) return;
            if (_panTilt == null) return;
            if (Twinny.Multiplatform.Input.InputProvider.CurrentData.TouchCount > 0) return;
        ...
        private void SyncCameraToCurrentGyroRotation()
        {
            ...
            Vector3? gyroRotation = Twinny.Multiplatform.Input.InputProvider.CurrentData.GyroRotation;
        ...
        private void UpdateZoom()
        {
            ...
            bool isHoldingPinchTouch = Twinny.Multiplatform.Input.InputProvider.CurrentData.TouchCount >= 2;
