...
namespace Twinny.Multiplatform.Editor.Navigation
{
    [CustomEditor(typeof(FpsNavigation))]
    public class FpsNavigationEditor : UnityEditor.Editor
    {
        ...
        private void AddRuntimeFields(VisualElement container)
        {
            ...
            AddHelpLabel(container, "Uses OnSelect(SelectionData) from InputProvider/Emulator.");
        }
