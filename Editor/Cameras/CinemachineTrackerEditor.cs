...
namespace Twinny.Multiplatform.Editor.Cameras
{
    ...
    public class CinemachineTrackerEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualElement orbitalSection = CreateSection(contentRoot, "Orbital Overrides");
            AddZeroValueWarning(orbitalSection);
            AddOrbitalFields(orbitalSection);
            AddPanConstraintFields(CreateSection(contentRoot, "Pan Constraint"));
            AddDemoFields(CreateSection(contentRoot, "Demo Mode"));
        ...
        private void ApplyTitle(VisualElement root)
        {
            ...
            if (title != null) title.text = "Cinemachine Tracker";
        ...
        private void AddComputedInfo(VisualElement container)
        {
            ...
            var poi = target as CinemachineTracker;
            if (poi == null) return;
