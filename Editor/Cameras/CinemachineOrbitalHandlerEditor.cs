...
namespace Twinny.Multiplatform.Editor.Camera
{
    [InitializeOnLoad]
    [CustomEditor(typeof(CinemachineOrbitalHandler))]
    public class CinemachineOrbitalHandlerEditor : UnityEditor.Editor
    {
        ...
        private const string ApplyKeyPrefix = "Twinny.Multiplatform.RuntimeApply.";
        private const string ApplyKeysList = "Twinny.Multiplatform.RuntimeApply.Keys";
        ...
        static CinemachineOrbitalHandlerEditor()
        {
        ...
        private void AddCinemachineFields(VisualElement container)
        {
            ...
            var handler = (CinemachineOrbitalHandler)target;
        ...
        private CinemachineCamera GetCinemachineCamera(CinemachineOrbitalHandler handler)
        {
            return handler != null ? handler.GetComponent<CinemachineCamera>() : null;
        }

        private CinemachineOrbitalFollow GetOrbitalFollow(CinemachineOrbitalHandler handler)
        {
        ...
        private static void SaveRuntimeSnapshot(CinemachineOrbitalHandler handler)
        {
            if (handler == null) return;
        ...
        private static Transform GetCustomPanTarget(CinemachineOrbitalHandler handler)
        {
            if (handler == null) return null;
        ...
        private static void ApplyPayload(RuntimeApplyPayload payload)
        {
            ...
            var handler = GetObjectFromId<CinemachineOrbitalHandler>(payload.handlerId);
            if (handler == null) return;
