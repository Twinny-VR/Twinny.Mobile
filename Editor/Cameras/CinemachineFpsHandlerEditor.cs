...
{
    [CustomEditor(typeof(CinemachineFpsHandler))]
    public class CinemachineFpsHandlerEditor : UnityEditor.Editor
    {
        ...
        private void AddCinemachineFields(VisualElement container)
        {
            ...
            var handler = (CinemachineFpsHandler)target;
        ...
        private CinemachineCamera GetCinemachineCamera(CinemachineFpsHandler handler)
        {
            return handler != null ? handler.GetComponent<CinemachineCamera>() : null;
        }

        private CinemachinePanTilt GetPanTilt(CinemachineFpsHandler handler)
        {
