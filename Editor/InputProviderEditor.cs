...
namespace Twinny.Multiplatform.Editor.Input
{
    [CustomEditor(typeof(InputProvider))]
    public class InputProviderEditor : UnityEditor.Editor
    {
        private const string SETTINGS_PATH = "Assets/Resources/InputSettings.asset";
        private const string SETTINGS_RESOURCE_NAME = "InputSettings";
        ...
        private void EnsureSettingsExistAndAssigned()
        {
            ...
            var settings = Resources.Load<InputSettings>(SETTINGS_RESOURCE_NAME);
            ...
            if (settings == null)
            {
                ...
                settings = AssetDatabase.LoadAssetAtPath<InputSettings>(SETTINGS_PATH);
                ...
                if (settings == null)
                {
                    ...
                    Debug.Log($"[InputProvider] Created global settings at {SETTINGS_PATH}");
                }
            }
